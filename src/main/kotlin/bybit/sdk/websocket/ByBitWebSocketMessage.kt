...
sealed class ByBitWebSocketMessage {
    ...
    sealed class StocksMessage : ByBitWebSocketMessage() {
    ...
    sealed class ForexMessage : ByBitWebSocketMessage() {
    ...
    sealed class CryptoMessage : ByBitWebSocketMessage() {
        ...
        data class Quote(
            ...
            @SerialName("x") val exchangeId: Long? = null,
            @SerialName("r") val receivedAtByBitTimestamp: Long? = null
        ) : CryptoMessage()
    ...
    sealed class IndicesMessage : ByBitWebSocketMessage() {
        /**
